// Markup.cpp: implementation of the C_BurXMLFile class.
//
// Markup Release 10.1
...
C_BurXMLFile& C_BurXMLFile::operator=( const C_BurXMLFile& markup )
{
...
bool C_BurXMLFile::SetDoc( MCD_PCSZ pDoc )
{
	// Set document text
	if ( pDoc )
		m_strDoc = pDoc;
...
bool C_BurXMLFile::SetDoc( const MCD_STR& strDoc )
{
	m_strDoc = strDoc;
	MCD_STRCLEAR(m_strError);
	return x_ParseDoc();
...
bool C_BurXMLFile::IsWellFormed()
{
	if ( m_aPos.GetSize()
...
bool C_BurXMLFile::Load( MCD_CSTR_FILENAME szFileName )
{
...
bool C_BurXMLFile::ReadTextFile( MCD_CSTR_FILENAME szFileName, MCD_STR& strDoc, MCD_STR* pstrError, int* pnDocFlags, MCD_STR* pstrEncoding )
{
...
bool C_BurXMLFile::Save( MCD_CSTR_FILENAME szFileName )
{
	return WriteTextFile( szFileName, m_strDoc, &m_strError, &m_nDocFlags );
}

bool C_BurXMLFile::WriteTextFile( MCD_CSTR_FILENAME szFileName, const MCD_STR& strDoc, MCD_STR* pstrError, int* pnDocFlags, MCD_STR* pstrEncoding )
{
...
bool C_BurXMLFile::FindElem( MCD_CSTR szName )
{
...
bool C_BurXMLFile::FindChildElem( MCD_CSTR szName )
{
...
MCD_STR C_BurXMLFile::EscapeText( MCD_CSTR szText, int nFlags )
{
...
MCD_STR C_BurXMLFile::UnescapeText( MCD_CSTR szText, int nTextLength /*=-1*/ )
{
...
bool C_BurXMLFile::DetectUTF8( const char* pText, int nTextLen, int* pnNonASCII/*=NULL*/ )
{
...
int C_BurXMLFile::DecodeCharUTF8( const char*& pszUTF8, const char* pszUTF8End/*=NULL*/ )
{
...
void C_BurXMLFile::EncodeCharUTF16( int nUChar, unsigned short* pwszUTF16, int& nUTF16Len )
{
...
int C_BurXMLFile::DecodeCharUTF16( const unsigned short*& pwszUTF16, const unsigned short* pszUTF16End/*=NULL*/ )
{
...
void C_BurXMLFile::EncodeCharUTF8( int nUChar, char* pszUTF8, int& nUTF8Len )
{
...
int C_BurXMLFile::UTF16To8( char* pszUTF8, const unsigned short* pwszUTF16, int nUTF8Count )
{
...
int C_BurXMLFile::UTF8To16( unsigned short* pwszUTF16, const char* pszUTF8, int nUTF8Count )
{
...
MCD_STR C_BurXMLFile::UTF8ToA( MCD_CSTR pszUTF8, int* pnFailed/*=NULL*/ )
{
...
MCD_STR C_BurXMLFile::AToUTF8( MCD_CSTR pszANSI )
{
...
MCD_STR C_BurXMLFile::GetDeclaredEncoding( MCD_CSTR szDoc )
{
...
int C_BurXMLFile::FindNode( int nType )
{
...
MCD_STR C_BurXMLFile::GetTagName() const
{
...
MCD_STR C_BurXMLFile::GetAttribName( int n ) const
{
...
bool C_BurXMLFile::SavePos( MCD_CSTR szPosName /*=""*/, int nMap /*=0*/ )
{
...
bool C_BurXMLFile::RestorePos( MCD_CSTR szPosName /*=""*/, int nMap /*=0*/ )
{
...
bool C_BurXMLFile::SetMapSize( int nSize, int nMap /*=0*/ )
{
...
bool C_BurXMLFile::RemoveChildElem()
{
...
MCD_STR C_BurXMLFile::x_GetLastError()
{
...
bool C_BurXMLFile::x_AllocPosArray( int nNewSize /*=0*/ )
{
...
int C_BurXMLFile::x_ParseElem( int iPosParent, TokenPos& token )
{
...
bool C_BurXMLFile::x_FindAny( MCD_PCSZ pDoc, int& nChar )
{
...
bool C_BurXMLFile::x_FindName( C_BurXMLFile::TokenPos& token )
{
...
MCD_STR C_BurXMLFile::x_GetToken( const C_BurXMLFile::TokenPos& token )
{
...
int C_BurXMLFile::x_FindElem( int iPosParent, int iPos, MCD_PCSZ pPath ) const
{
...
int C_BurXMLFile::x_ParseNode( C_BurXMLFile::TokenPos& token, C_BurXMLFile::NodePos& node )
{
...
MCD_STR C_BurXMLFile::x_GetPath( int iPos ) const
{
	MCD_STR strPath;
	while ( iPos )
	{
...
MCD_STR C_BurXMLFile::x_GetTagName( int iPos ) const
{
...
bool C_BurXMLFile::x_FindAttrib( C_BurXMLFile::TokenPos& token, MCD_PCSZ pAttrib, int n/*=0*/ )
{
...
MCD_STR C_BurXMLFile::x_GetAttrib( int iPos, MCD_PCSZ pAttrib ) const
{
...
bool C_BurXMLFile::x_SetAttrib( int iPos, MCD_PCSZ pAttrib, int nValue, int nFlags /*=0*/ )
{
...
bool C_BurXMLFile::x_SetAttrib( int iPos, MCD_PCSZ pAttrib, MCD_PCSZ pValue, int nFlags /*=0*/ )
{
...
bool C_BurXMLFile::x_CreateNode( MCD_STR& strNode, int nNodeType, MCD_PCSZ pText )
{
...
MCD_STR C_BurXMLFile::x_EncodeCDATASection( MCD_PCSZ szData )
{
...
bool C_BurXMLFile::x_SetData( int iPos, int nValue )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( MCD_SSZ(szVal), MCD_T("%d"), nValue );
...
bool C_BurXMLFile::x_SetData( int iPos, MCD_PCSZ szData, int nFlags )
{
...
MCD_STR C_BurXMLFile::x_GetData( int iPos ) const
{
	if ( iPos == m_iPos && m_nNodeLength )
	{
...
MCD_STR C_BurXMLFile::x_GetElemContent( int iPos ) const
{
...
bool C_BurXMLFile::x_SetElemContent( MCD_PCSZ szContent )
{
...
void C_BurXMLFile::x_DocChange( int nLeft, int nReplace, const MCD_STR& strInsert )
{
...
void C_BurXMLFile::x_Adjust( int iPos, int nShift, bool bAfterPos /*=false*/ )
{
...
int C_BurXMLFile::x_InsertNew( int iPosParent, int& iPosRel, C_BurXMLFile::NodePos& node )
{
...
bool C_BurXMLFile::x_AddElem( MCD_PCSZ pName, int nValue, int nFlags )
{
	// Convert integer to string
	MCD_CHAR szVal[25];
	MCD_SPRINTF( MCD_SSZ(szVal), MCD_T("%d"), nValue );
...
bool C_BurXMLFile::x_AddElem( MCD_PCSZ pName, MCD_PCSZ pValue, int nFlags )
{
	if ( nFlags & MNF_CHILD )
	{
...
MCD_STR C_BurXMLFile::x_GetSubDoc( int iPos ) const
{
	if ( iPos )
	{
...
bool C_BurXMLFile::x_AddSubDoc( MCD_PCSZ pSubDoc, int nFlags )
{
...
int C_BurXMLFile::x_RemoveElem( int iPos )
{
...
void C_BurXMLFile::x_LinkElem( int iPosParent, int iPosBefore, int iPos )
{
...
int C_BurXMLFile::x_UnlinkElem( int iPos )
{
...
int C_BurXMLFile::x_ReleasePos( int iPos )
{
...
int C_BurXMLFile::x_ReleaseSubDoc( int iPos )
{
...
bool C_BurXMLFile::x_GetMap( SavedPosMap*& pMap, int nMap, int nMapSize /*=7*/ )
{
...
void C_BurXMLFile::x_CheckSavedPos()
{
...
void C_BurXMLFile::x_AdjustForNode( int iPosParent, int iPos, int nShift )
{
...
bool C_BurXMLFile::x_AddNode( int nNodeType, MCD_PCSZ pText, int nNodeFlags )
{
...
void C_BurXMLFile::x_RemoveNode( int iPosParent, int& iPos, int& nNodeType, int& nNodeOffset, int& nNodeLength )
{
...
int C_BurXMLFile::x_GetEncodingCodePage( MCD_CSTR pszEncoding )
{
...
#if ! defined(MARKUP_WCHAR)
bool C_BurXMLFile::x_CanConvert( MCD_CSTR pszToEncoding, MCD_CSTR pszFromEncoding )
{
...
#if defined(MARKUP_ICONV)
const char* C_BurXMLFile::x_IConvName( char* szEncoding, MCD_CSTR pszEncoding )
{
...
int C_BurXMLFile::x_IConv( ConvertEncoding& convert, void* pTo, int nToCharSize, int nFromCharSize )
{
...
int C_BurXMLFile::x_ConvertEncoding( ConvertEncoding& convert, void* pTo )
{
...
bool C_BurXMLFile::x_EndianSwapRequired( int nDocFlags )
{
	short nWord = 1;
...
void C_BurXMLFile::x_EndianSwapUTF16( unsigned short* pBuffer, int nCharLen )
{
...
{
	{ "\xef\xbb\xbf", 3, MCD_T("UTF-8"), C_BurXMLFile::MDF_UTF8PREAMBLE },
	{ "\xff\xfe", 2, MCD_T("UTF-16LE"), C_BurXMLFile::MDF_UTF16LEFILE },
	{ "\xfe\xff", 2, MCD_T("UTF-16BE"), C_BurXMLFile::MDF_UTF16BEFILE },
	{ NULL,0,NULL,0 }
};

bool C_BurXMLFile::x_Open( MCD_CSTR_FILENAME szFileName, FilePos& file )
{
...
bool C_BurXMLFile::x_Read( void* pBuffer, FilePos& file )
{
...
bool C_BurXMLFile::x_ReadText( MCD_STR& strDoc, FilePos& file )
{
	bool bSuccess = true;
	MCD_CHAR szReadInfo[100] = {0};
	MCD_STRCLEAR( file.strIOResult );
...
bool C_BurXMLFile::x_Write( void* pBuffer, FilePos& file, const void* pConstBuffer /*=NULL*/ )
{
...
bool C_BurXMLFile::x_WriteText( const MCD_STR& strDoc, FilePos& file )
{
	bool bSuccess = true;
	MCD_CHAR szWriteInfo[100] = {0};
	MCD_STRCLEAR( file.strIOResult );
...
bool C_BurXMLFile::x_Close( FilePos& file )
{
	if ( file.fp )
	{
		fclose( file.fp );
